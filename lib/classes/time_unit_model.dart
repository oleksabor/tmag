...
class TimeUnitModelFake extends TimeUnitModel {
  ...
  static List<TimeUnit> items = [
    // first schedule
    TimeUnit(Time(1, 0), h4),
    TimeUnit(Time(5, 0), h4),
    TimeUnit(Time(9, 0), h4),
    TimeUnit(Time(13, 0), h4),
    TimeUnit(Time(17, 0), h4),
    TimeUnit(Time(21, 0), h4),
    // second schedule
    TimeUnit(Time(3, 0), h6),
    TimeUnit(Time(9, 0), h6),
    TimeUnit(Time(15, 0), h6),
    TimeUnit(Time(21, 0), h6),
    // non working schedule
    TimeUnit(Time(19, 0), h24),
  ];
